...
public class CredentialInfoRepository
        ...
        LoginInfo, CredentialInfo, String> {

    public CredentialInfoRepository() {
        super(new LoginInfoRepository());
    }

    @Override
    protected LoginInfo extractParent(CredentialInfo entity) {
        return entity.getLoginInfo();
    }

    @Override
    protected CredentialInfo extractChild(LoginInfo entity) {
        return entity.getCredentialInfo();
    }
}
